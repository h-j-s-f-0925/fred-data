...
export function LaborStatsChart() {
  const { data, loading, error } = useFredData('unemployment');
    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-6 h-full">
        ...
        <div className="h-80 flex items-center justify-center">
          ...
          <span className="ml-2 text-gray-600">Loading unemployment data...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow-md p-6 h-full">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        ...
        >
          ...
          View on FRED: Unemployment Rate
        </a>
      </div>
    </div>
  );
